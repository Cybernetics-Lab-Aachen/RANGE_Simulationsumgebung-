...
/* TrajectoryRequest_subscriber.cxx
...
Example subscription of type range_TrajectoryRequest automatically generated by 
...
void range_TrajectoryRequestListener::on_data_available(DDSDataReader* reader)
{
    ...
    for (i = 0; i < data_seq.length(); ++i) {
        if (info_seq[i].valid_data) {
            ...
            range_TrajectoryRequestTypeSupport::print_data(&data_seq[i]);
        }
    }
...
extern "C" int subscriber_main(int domainId, int sample_count)
{
    ...
    topic = participant->create_topic(
        "Example range_TrajectoryRequest",
    ...
    reader_listener = new range_TrajectoryRequestListener();
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
        ...
        printf("range_TrajectoryRequest subscriber sleeping for %d sec...\n",
        receive_period.sec);
