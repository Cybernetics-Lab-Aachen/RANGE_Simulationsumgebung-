...
extern "C" int publisher_main(int domainId, int sample_count)
{
    ...
    range_Return_writer = range_ReturnDataWriter::narrow(writer);
    if (range_Return_writer == NULL) {
    ...
    instance = range_ReturnTypeSupport::create_data();
    if (instance == NULL) {
        printf("range_ReturnTypeSupport::create_data error\n");
        publisher_shutdown(participant);
        return -1;
    }
    ...
    /*
    instance_handle = range_Return_writer->register_instance(*instance);
    */

    /* Main loop */
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {

        printf("Writing range_Return, count %d\n", count);

        /* Modify the data to be sent here */

        retcode = range_Return_writer->write(*instance, instance_handle);
        if (retcode != DDS_RETCODE_OK) {
    ...
    /*
    retcode = range_Return_writer->unregister_instance(
    ...
    */
    ...
    /* Delete data sample */
    retcode = range_ReturnTypeSupport::delete_data(instance);
    if (retcode != DDS_RETCODE_OK) {
        printf("range_ReturnTypeSupport::delete_data error %d\n", retcode);
    }
