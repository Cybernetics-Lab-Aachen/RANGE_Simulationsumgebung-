...
Example subscription of type gazebo_PositionPluginRequest automatically generated by 
...
void gazebo_PositionPluginRequestListener::on_data_available(DDSDataReader* reader)
{
    ...
    for (i = 0; i < data_seq.length(); ++i) {
        if (info_seq[i].valid_data) {
            ...
            gazebo_PositionPluginRequestTypeSupport::print_data(&data_seq[i]);
        }
    }
...
extern "C" int subscriber_main(int domainId, int sample_count)
{
    ...
    topic = participant->create_topic(
        "Example gazebo_PositionPluginRequest",
    ...
    reader_listener = new gazebo_PositionPluginRequestListener();
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
        ...
        printf("gazebo_PositionPluginRequest subscriber sleeping for %d sec...\n",
        receive_period.sec);
