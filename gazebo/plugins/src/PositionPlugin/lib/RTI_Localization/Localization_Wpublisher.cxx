...
de_dlr_enex_datamodel_range_LocalizationDataWriter * writerPointer;
...
extern "C" int publisher_main(int domainId, char* topicName)
{
    ...
    writerPointer = de_dlr_enex_datamodel_range_LocalizationDataWriter::narrow(writer);
    if (writer == NULL) {
...
int publisher_init(int domainId, char* topicName)
{
    ...
    */
    ...
    return publisher_main(domainId, topicName);
}
...
extern "C" DDS_ReturnCode_t publisher_write(de_dlr_enex_datamodel_range_Localization *instance){
	 ...
	 retcode = writerPointer->write(*instance, DDS_HANDLE_NIL);
