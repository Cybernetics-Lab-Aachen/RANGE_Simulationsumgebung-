...
DDS_TypeCode* range_TrajectoryRequest_get_typecode()
{
    ...
    static DDS_TypeCode range_TrajectoryRequest_g_tc_id_string = DDS_INITIALIZE_STRING_TYPECODE((64));
    static DDS_TypeCode range_TrajectoryRequest_g_tc_expressionX_string = DDS_INITIALIZE_STRING_TYPECODE((64));
    static DDS_TypeCode range_TrajectoryRequest_g_tc_expressionY_string = DDS_INITIALIZE_STRING_TYPECODE((64));
    static DDS_TypeCode range_TrajectoryRequest_g_tc_expressionZ_string = DDS_INITIALIZE_STRING_TYPECODE((64));
    ...
    range_TrajectoryRequest* sample, const struct DDS_TypeAllocationParams_t * allocParams)
{
    ...
    if (allocParams->allocate_memory){
        sample->expressionX= DDS_String_alloc ((64));
    ...
    if (allocParams->allocate_memory){
        sample->expressionY= DDS_String_alloc ((64));
    ...
    if (allocParams->allocate_memory){
        sample->expressionZ= DDS_String_alloc ((64));
